...
You should see messages similar to the following:
    ...
    INFO  [Project-1.controller.MemberRegistration] (http--127.0.0.1-8080-2) Registering Jane Doe
    INFO  [Project-1.test.MemberRegistrationTest] (http--127.0.0.1-8080-2) Jane Doe was persisted with id 1
